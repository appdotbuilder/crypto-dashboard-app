...
export const executeSellOrder = async (input: SellOrderInput): Promise<Transaction> => {
    ...
    // The goal of this handler is to execute a sell order for cryptocurrency,
    // validate user has sufficient crypto balance, calculate fees, create transaction record,
    ...
    return Promise.resolve({
        id: 2, // Database ID after insertion
        ...
        total_value: totalValue - fee, // Subtract fee from proceeds
        fee: fee,
